...
class JazShopEasyformOrders(BrowserView, DateMixin):
    ...
    def __call__(self):
        ...
        if not self.context.portal_type == "EasyForm":
            return
        ...
        easy_form = self.context
        form_uid = IUUID(easy_form)

        # Filter orders to those generated by this form
        orders = [o for o in order_list if form_uid in o.get('pfg_forms', {})] # legacy orders are stored in 'pfg_forms' key. XXX add easyform_forms
        orders_csv = StringIO()
